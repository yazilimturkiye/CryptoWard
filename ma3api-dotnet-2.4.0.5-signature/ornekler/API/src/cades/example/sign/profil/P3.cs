...
namespace tr.gov.tubitak.uekae.esya.api.cades.example.sign.profil
{
    ...
    public class P3 : CadesSampleBase
    {
        ...
        public void testCreatePreP3()
        {
            ...
            FileUtil.writeBytes(testDataDirectory.FullName + @"\preP3.p7s", signedDocument);
        }

        public void testUpgradeP3()
        {
            byte[] signature = FileUtil.readBytes(getTestDataFolder() + "preP3.p7s");
            ...
            FileUtil.writeBytes(getTestDataFolder() + "P3.p7s", signedDocument);
