...
namespace ImzaApiTest.src.tr.gov.tubitak.uekae.esya.api
{
    public class SampleBase
    {
        ...
        /**
         * Aşağıda adresten test pfx'lerini indirebilirsiniz. 
         * https://kamusm.bilgem.tubitak.gov.tr/hizmetler/test_sistemi/test_sistemi_kullanici_sertifikalari.jsp
         * **/
        protected String getPFXPath()
        {
            throw new Exception("Set pfx file path!");
            //return getRootDir() + "/sertifika deposu/test1@test.com_238549.pfx";
        }
