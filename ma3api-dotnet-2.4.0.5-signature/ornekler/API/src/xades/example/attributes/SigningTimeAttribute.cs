...
{
    /**
     * BES with SigningTime attribute sample
     */

    [TestFixture]
    public class SigningTimeAttribute : XadesSampleBase
    {
        public static readonly string SIGNATURE_FILENAME = "signing_time.xml";

        /**
         * Creates detached BES with SigningTime attribute
         */

        [Test]
        public void createBESWithSigningTime()
        {
